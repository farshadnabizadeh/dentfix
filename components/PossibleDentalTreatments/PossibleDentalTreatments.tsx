                ...
                <div className='w-full h-[733px] absolute z-10 top-[200px] px-[50px] 2xl:px-[240px] flex justify-center'>
                    <div className='w-full h-full relative'>
                        <div className='w-full h-full absolute z-0 flex justify-end'>
                            <div className='w-[610px] h-[633px] 2xl:w-[710px] 2xl:h-[733px] -translate-x-[100px] translate-y-4 2xl:translate-y-0 2xl:translate-x-0 relative'>
                        ...
                        <div className='w-[750px] 2xl:w-[647px] top-[100px] absolute z-40 border-2 border-[blue]'>
